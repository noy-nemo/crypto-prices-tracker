  ...
  GITHUB_TOKEN="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"
  ...
  gh pr create --title "chore: README date update" --base main --head "$BRANCH" --body "Automated PR — adds current date ($DATE) to README.md via postinstall script"
